...
public class NotificationUtils {
    private static final int PENDING_INTENT_UNIQUE = 11;
    private static final String WATER_REMINDER_CHANNEL_ID = "reminder_notification_channel";
    private static final int WATER_REMINDER_NOTIFICATION_ID = 5;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel mChannel = new NotificationChannel(WATER_REMINDER_CHANNEL_ID, context.getString(R.string.main_notification_channel_name), NotificationManager.IMPORTANCE_HIGH);
        ...
        NotificationCompat.Builder nBuilder = new NotificationCompat.Builder(context, WATER_REMINDER_CHANNEL_ID)
        ...
        notificationManager.notify(WATER_REMINDER_NOTIFICATION_ID, nBuilder.build());
    }
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, PENDING_INTENT_UNIQUE, startActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT);
