...
public class NotificationUtils {
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignoreReminderPendingIntent = PendingIntent.getService(context, ACTION_IGNORE_PENDING_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(R.drawable.ic_drink_notification, "Drink water", drinkWaterPendingIntent);
