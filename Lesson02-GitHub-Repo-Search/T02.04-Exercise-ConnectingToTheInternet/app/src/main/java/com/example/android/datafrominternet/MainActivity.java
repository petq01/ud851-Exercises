...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        try {
            URL textEditResult = new URL(mSearchBoxEditText.getText().toString());
            mSearchResultsTextView.setText(NetworkUtils.getResponseFromHttpUrl(textEditResult).toString());
        } catch (IOException e) {
            e.printStackTrace();
        }
